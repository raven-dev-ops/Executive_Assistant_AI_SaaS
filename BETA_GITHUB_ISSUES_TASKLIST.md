...
--------------------------
- Operational hardening for ISO 27001: ISMS docs, recurring risk reviews, access reviews/SSO, backup & restore drills, vendor register with DPAs, scheduled internal audit/management review, and external certification plan (see `docs/ISMS` folder).
